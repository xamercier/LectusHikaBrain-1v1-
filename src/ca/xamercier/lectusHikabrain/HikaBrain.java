...
public class HikaBrain extends JavaPlugin {
	...
	private final String prefix = ChatColor.GOLD + "[HikaBrain] ";
	...
	public void onEnable() {
		...
		/*
		getServer().createWorld(new WorldCreator("HikaBrainEnd"));
		getServer().createWorld(new WorldCreator("WaitHika"));
		*/
